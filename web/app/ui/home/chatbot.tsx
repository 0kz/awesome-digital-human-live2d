        ...
        <div className="p-2 sm:p-6 justify-between flex flex-col h-full">
            ...
            <div className="px-4 pt-4 mb-2 sm:mb-0 z-10 w-full">
                <div className="relative flex">
                    ...
                    <input enterKeyHint="send" type="text" disabled={isProcessing} placeholder="请输入您想说的。。" ref={inputRef} onKeyDown={enterPress} className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3" />
